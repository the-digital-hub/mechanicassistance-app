...
export default function ASEScreen() {
    ...
    const handleSearch = async () => {
        ...
        try {
            ...
            if (err instanceof ApiError && err.status === 404) {
                setSearchError('No ASE mechanic found with that ID. Please verify and try again.');
            } else {
    ...
    const handleAssociate = async () => {
        ...
        try {
            ...
            setSearchError('Failed to link your ASE membership. Please try again.');
        } finally {
                            ...
                            >
                                ...
                                >
                                    {isAssociating ? (
                                        ...
                                        <>
                                            <Text className="text-white font-outfit-bold text-center mr-2">Link ASE Membership</Text>
                                            <ChevronRight size={20} color="white" />
                                        </>
                                    )}
                                </LinearGradient>
